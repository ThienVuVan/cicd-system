  ...
  async createProduct(req, res) {
    try {
      if (req.files != undefined) {
        req.body.image1 = "https://emark.thienvuvan.io.vn/" + req.files[0].path;
        if (req.files[1] != undefined) {
          req.body.image2 = "https://emark.thienvuvan.io.vn/" + req.files[1].path;
          if (req.files[2] != undefined) {
            req.body.image3 = "https://emark.thienvuvan.io.vn/" + req.files[2].path;
            if (req.files[3] != undefined) {
              req.body.image4 = "https://emark.thienvuvan.io.vn/" + req.files[3].path;
              if (req.files[4] != undefined) {
                req.body.image5 = "https://emark.thienvuvan.io.vn/" + req.files[4].path;
                if (req.files[5] != undefined) {
                  req.body.image6 =
                    "https://emark.thienvuvan.io.vn/" + req.files[5].path;
                  if (req.files[6] != undefined) {
                    req.body.image7 =
                      "https://emark.thienvuvan.io.vn/" + req.files[6].path;
                    if (req.files[7] != undefined) {
                      req.body.image8 =
                        "https://emark.thienvuvan.io.vn/" + req.files[7].path;
                      if (req.files[8] != undefined) {
                        req.body.image9 =
                          "https://emark.thienvuvan.io.vn/" + req.files[8].path;
                        if (req.files[9] != undefined) {
                          req.body.image10 =
                            "https://emark.thienvuvan.io.vn/" + req.files[9].path;
                        }
                      }
                    }
                  }
